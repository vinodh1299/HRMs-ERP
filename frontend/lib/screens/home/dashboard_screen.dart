...
class _DashboardScreenState extends ConsumerState<DashboardScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDepartmentPortalsRow() {
    ...
    final list = [
      ...
      if (isAdmin) ...[
        {'name': 'ETS', 'icon': Icons.school_outlined, 'color': Colors.blueGrey},
        {'name': 'AGAPE', 'icon': Icons.local_hospital_outlined, 'color': Colors.redAccent},
        {'name': 'ACHS', 'icon': Icons.local_library_outlined, 'color': Colors.cyan},
        {'name': 'ROH', 'icon': Icons.volunteer_activism_outlined, 'color': Colors.pinkAccent},
        {'name': 'ACCASI', 'icon': Icons.local_cafe_outlined, 'color': Colors.brown},
        {'name': 'HOJ', 'icon': Icons.child_care_outlined, 'color': Colors.orangeAccent},
        ...
        {'name': 'ACASC', 'icon': Icons.account_balance_outlined, 'color': Colors.lightBlue},
  ...
  void _openDepartmentSheet(BuildContext context, String deptName, IconData icon, Color color) {
    final Map<String, List<String>> services = {
      ...
      'ETS': ['Academic transcript request', 'Library card renewal', 'Seminar booking'],
      'AGAPE': ['Medical appointments', 'Emergency contact support', 'Health checkup booking'],
      'ACHS': ['Admission query', 'Student records request', 'PTA meeting slot'],
      'ROH': ['Therapy session booking', 'Consultation request', 'Autism support resources'],
      'ACCASI': ['Catering order booking', 'Menu feedback submission', 'Table reservation'],
      'HOJ': ['Child care enrollment', 'Activity log query', 'Volunteer application'],
      ...
      'ACASC': ['Course registration slot', 'Lab equipment reservation', 'Grant application query'],
