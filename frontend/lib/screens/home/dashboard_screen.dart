...
class _DashboardScreenState extends ConsumerState<DashboardScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDepartmentPortalsRow() {
    ...
    final list = [
      ...
      if (isAdmin) ...[
        {'name': 'Evangelical Seminary', 'icon': Icons.school_outlined, 'color': Colors.blueGrey},
        {'name': 'Agape Hospital', 'icon': Icons.local_hospital_outlined, 'color': Colors.redAccent},
        {'name': 'ACHS High School', 'icon': Icons.local_library_outlined, 'color': Colors.cyan},
        {'name': 'Ray of Hope', 'icon': Icons.volunteer_activism_outlined, 'color': Colors.pinkAccent},
        {'name': 'ACCASI Cafe', 'icon': Icons.local_cafe_outlined, 'color': Colors.brown},
        {'name': 'House of Joy', 'icon': Icons.child_care_outlined, 'color': Colors.orangeAccent},
        ...
        {'name': 'Library', 'icon': Icons.menu_book_outlined, 'color': Colors.indigo},
        ...
        {'name': 'ACASC College', 'icon': Icons.account_balance_outlined, 'color': Colors.lightBlue},
  ...
  void _openDepartmentSheet(BuildContext context, String deptName, IconData icon, Color color) {
    final Map<String, List<String>> services = {
      ...
      'Evangelical Seminary': ['Academic transcript request', 'Library card renewal', 'Seminar booking'],
      'Agape Hospital': ['Medical appointments', 'Emergency contact support', 'Health checkup booking'],
      'ACHS High School': ['Admission query', 'Student records request', 'PTA meeting slot'],
      'Ray of Hope': ['Therapy session booking', 'Consultation request', 'Autism support resources'],
      'ACCASI Cafe': ['Catering order booking', 'Menu feedback submission', 'Table reservation'],
      'House of Joy': ['Child care enrollment', 'Activity log query', 'Volunteer application'],
      ...
      'ACASC College': ['Course registration slot', 'Lab equipment reservation', 'Grant application query'],
